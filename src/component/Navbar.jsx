...
function Navbar() {
    ...
    return (
        <header className='border-b px-[20px]'>
            <Container>
                {/* 
                mobile  view */}
                    ...
                    <div className='flex justify-between pt-[46px] pb-[23px] items-center'>
                        ...
                        <div className=' text-end'>
                            <div className='flex gap-[13px] items-center'>
                                ...
                                <CommonBtn className={"bg-[#1E1E1E] text-[10px] px-[10px] md:text-[28px]"}>MyFeedback for business</CommonBtn>
                            </div>
                        </div>
                    </div>

                    <div className='border rounded-full w-[100%] py-[4px] relative'>
