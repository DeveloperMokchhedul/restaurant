        ...
        <div className='md:w-[504px]' >
            <div className='flex items-center gap-[15px]'>
                ...
                <div className='flex flex-col gap-[11px]'>
                    ...
                    <p className='text-[12px] nd:text-[14px] font-semibold font-roboto leading-[16.41px]'>rating: 5.0 <span className='font-normal font-roboto text-[#7A7A7A]'>(876 reviews)</span></p>
                </div>
            </div>
